  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        {/* Mobile Nav (Con el botón de ingresar arreglado) */}
        <div className="md:hidden flex items-center gap-3">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-[#5D4037] text-white">
              <SheetHeader>
                <SheetTitle className="text-[#E5D3B3] font-serif text-2xl flex items-center gap-2">
                  <img src="/logo.png" alt="Logo" className="w-8 h-8 rounded-full" /> MAROBEL
                </SheetTitle>
                <SheetDescription className="hidden">Menú</SheetDescription>
              </SheetHeader>
