...
const catalog: CatalogDefinition[] = [
  ...
  { nombre: "Manicura en acrílico", aliases: ["Manicura técnica en acrílico"], descripcion: "Extensión en acrílico; el valor final depende del tamaño.", categoria: "Manicura y pedicura", seccion: "Manicura", precio: 25, precio_desde: true },
  ...
  { nombre: "Pedicura básica", aliases: ["Pedicura rusa, solo limpieza"], descripcion: "Limpieza técnica profunda de uñas y cutículas.", categoria: "Manicura y pedicura", seccion: "Pedicura", precio: 10, precio_desde: false },
